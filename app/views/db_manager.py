...
# labeling related
    ...
    def upload_labeling_pose_by_id(self, data, bagid):
        print("upload labeling pose ....")
        result = {}
        db_label_data = self.mongo_db["labeling_pose"]

        insert_data = dict()

        insert_data["bagId"] = bagid
        insert_data["pose"] = data
    ...
    def get_labeling_pose_data(self, data_dict):
        print("into get labeling pose")
        result = []
        db_label_data = self.mongo_db["labeling_pose"]
        bag_id = data_dict["bagId"]
